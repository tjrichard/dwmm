...
function Works({ title, description, works, categories, tags, error }) {
  return (
    <div className="works-page">
      ...
      <main>
        <PortfolioHero works={works} />
        <section id="works-directory" className="works-directory">
...
export async function getStaticProps() {
  try {
    ...
    const transformedWorks = transformNotionData(notionPosts).filter(work => work.slug);
